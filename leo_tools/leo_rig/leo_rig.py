...
bones_tuples = [("head","DEF_head"),
                ...
                ("eye_L", "DEF_eye_L"),
                ("eye_L", "CTRL_eye_L"),
                ("eyes_lookat", "CTRL_eyes_lookat"),
                ("eye_lookat_L", "CTRL_eye_lookat_L"),
                ("eyelid_top_L", "CTRL_eyelid_top_L"),
                ("eyelid_bottom_L", "CTRL_eyelid_bottom_L"),
                ("eyebrow_L", "CTRL_eyebrow_L"),
                ("jaw", "DEF_jaw"),
                ("tongue_1", "DEF_tongue_1"),
                ("tongue_2", "DEF_tongue_2"),
                ("tongue_3", "DEF_tongue_3"),
                ("teeth_top", "DEF_teeth_top"),
                ("teeth_bottom", "DEF_teeth_bottom"),
                ("back_1", "DEF_back_1"),
                ("back_2", "DEF_back_2"),
                ("back_3", "DEF_back_3"),
                ("pelvis", "DEF_pelvis"),
